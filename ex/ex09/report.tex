...
\huge Katana FK \\ % The assignment title
...
Applying the formulas from the lecture (see \emph{ex09.m}), we find the
following absolute coordiantes:

\begin{enumerate}[a)]
    \item $ (329,   0,     313.3,  1) $
    \item $ (273.4, 0,     -179,   1) $
    \item $ (193.3, 193.3, -179,   1) $
    \item $ (139,   0,     -123.3, 1) $
    \item $ (98.3,  98.3,  -123.3, 1) $
\end{enumerate}
